...
const ProductWiseSpend = (props) => {
    ...
    return (
        ...
        //         </div>
        //         {
        //             props.value === NaN || props.value === undefined ?
        //                 <center>
        ...
        //                 <React.Fragment>
        //                     <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        //                         <h2 style={{ margin: 'auto 0', fontSize: "calc(100% + 0.5rem)" }}>€ {props.value}</h2>
        //                         <img src=
        //                             {props.icon} />
        //                             {/* size="50px" style={{ marginRight: '1.3rem' }}  */}
        //                     </div>
        //                     <p className="text-muted persentage-style">
        //                         {state}
...
export default ProductWiseSpend;
